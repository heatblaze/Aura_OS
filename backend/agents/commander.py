...
Available tools: google_calendar, gmail, web_search, browser_automation, twilio_call, twilio_sms, local_system (for launching desktop tasks, notepad, file explorer, or running shell commands), system_clock (for checking current date/time for specific cities or time zones), generate_image (for logo design, image synthesis, visual mockups, and graphic assets)
